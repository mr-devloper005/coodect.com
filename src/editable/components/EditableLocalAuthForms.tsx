...
const inputClass = 'h-12 rounded-lg border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#191b22] outline-none transition placeholder:text-slate-400 focus:border-[#d600b8] focus:ring-2 focus:ring-[#d600b8]/15'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-lg bg-[#d600b8] px-6 text-sm font-black uppercase tracking-[0.16em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
