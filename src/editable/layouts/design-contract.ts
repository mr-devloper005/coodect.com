...
export const editableRootStyle = {
  '--slot4-page-bg': '#f2f4f6',
  '--slot4-page-text': '#191b22',
  '--slot4-panel-bg': '#30303c',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#5f6877',
  '--slot4-soft-muted-text': '#778292',
  '--slot4-accent': '#d600b8',
  '--slot4-accent-fill': '#d600b8',
  '--slot4-accent-soft': '#f4e7f5',
  '--slot4-dark-bg': '#17181d',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dde3ea',
  '--slot4-cream': '#f2f4f6',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#30303c',
  '--slot4-gray': '#eef1f4',
  '--slot4-body-gradient': 'linear-gradient(180deg, #eef1f4 0%, #f7f8fa 44%, #eef1f4 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-extrabold leading-[1.04] tracking-tight sm:text-5xl lg:text-[3.7rem]',
